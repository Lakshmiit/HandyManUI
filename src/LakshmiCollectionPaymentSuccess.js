...
// const LakshmiCollectionPaymentSuccess = () => {
...
//   try {
//       const res = await fetch(`https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/LakshmiCollection/GetLakshmiCollectionDetails/${id}`);
...
//     navigate(`/profilePage/customer/${customerId}`);
//   };
...
//               <tr>
//                 <th>Ticket ID</th>
//                 <td>{orderBooking.lakshmiCollectionId}</td>
//               </tr>
//               <tr> 
//                 <th>Paid Amount</th>
//                 <td>₹ {amount}</td>
...
// export default LakshmiCollectionPaymentSuccess;
