    ...
    const fetchapartmentData = async () => {
      try {
        const response = await fetch(
          `https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/ApartmentRaiseTicket/GetApartmentMaintenanceRaiseTicket/${apartmentRaiseTicketId}`,
        );
        if (!response.ok) {
