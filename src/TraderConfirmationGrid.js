...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByExistingDealerId?category=${category1}&district=${district1}&dealerId=${userId}`;
//     // alert(category);
//     // alert(district);
//     // alert(userId);
//     axios
