...
useEffect(() => {
  console.log( productData, loading, status, addressType, state, district, pincode, customerId, mobileNumber,date);
}, [productData, loading, status, addressType, state, district, pincode, customerId, mobileNumber,date]);
