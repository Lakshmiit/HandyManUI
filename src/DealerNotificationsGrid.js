...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByExistingDealerId?category=${category}&district=${district}&dealerId=${userId}`;
//     axios
//       .get(url)
//       .then((response) => {
