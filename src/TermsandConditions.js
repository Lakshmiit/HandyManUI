    ...
    return (
     <>
        {/* <header className="header d-flex">
            <img className="h-100" src="img/Hm_Logo 1.png" alt="Handy Man Logo" />
        ...
        <div className="wrapper">
            <div className="container mt_120px h-100 p-0">
                <div align="center">
      ...
      {/* <label>
        ...
        />
         <a href="#" onClick={handleOpenTerms}>Terms and conditions (T&C) are a legally binding document that outlines the rules and expectations for using a product or service.
         </a>.
      </label>
      ...
      {showTerms && (
        <div className="popup">
          <div className="popup-content">
            <span className="close-button" onClick={handleCloseTerms}>&times;</span>
            <h2>Terms and Conditions</h2>
        </div>
        
        {/* Footer
        <footer classNameName="footer text-center mt-4">
            Powered by <span classNameName="text-primary strong">Lakshmi Sai Service Provider</span><br />
            <span classNameName="small">&copy; 2024 Lakshmi software development center. All rights reserved.</span>
        </footer> */}
    </div>
    )}
    </div>
