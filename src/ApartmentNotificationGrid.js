...
const AartmentRaiseTicketNotification = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/ApartmentRaiseTicket/GetGetApartmentMaintenanceForAdminList`
  ...
  const handleDelete = (ticketId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/RaiseTicket/${ticketId}`)
        .then(() => {
