...
useEffect(() => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/UploadLakshmiCollection/UploadLakshmiCollection`, {
        method: "POST",
        headers: {
