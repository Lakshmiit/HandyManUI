 ...
 const handleCategoryClick = async () => {
  ...
  {selectedCategory && (
    ...
    <div className="row g-5">
     {(selectedCategory ? products : productData)?.slice().reverse().map((product) => {
          ...
          <div key={product.id} className='col-lg-3'>
            ...
            <div className="card w-100 border-light rounded-4">
              ...
              <div className="card-body p-1 m-1">
                ...
                <div className="small text-muted fw-bold">MRP: <span style={{ textDecoration: 'line-through' }}>Rs {product.rate}</span></div>
              ...
              <div className="d-flex">
                ...
                <div> 
                  ...
                  <div className="small text-muted fw-bold">MRP: <span style={{ textDecoration: 'line-through' }}>{product.rate}</span></div>
...
<Modal show={showZoomModal} onHide={() => setShowZoomModal(false)} centered>
  ...
  <button 
    ...
    onClick={() => navigate(`/offersGuestIcons/customer/guest`)}
	  >
    Back
  </button>
</div>
...
export default GuestOffersProducts;
