...
const BuyProductNotificationGrid = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/api/BuyProduct/GetBuyProductDetailsForAdminList`
    axios.get(url)
      .then(response => {
  ...
  const handleDelete = (productId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/api/RaiseTicket/${productId}`)
        .then(() => {
