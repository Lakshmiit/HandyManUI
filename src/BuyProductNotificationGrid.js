...
const BuyProductNotificationGrid = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/BuyProduct/GetBuyProductDetailsForAdminList`
    axios.get(url)
      .then(response => {
  ...
  const handleDelete = (productId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/RaiseTicket/${productId}`)
        .then(() => {
