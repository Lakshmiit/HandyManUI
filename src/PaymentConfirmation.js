...
//       try {
//         const response = await fetch(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/Dealer/GetDealerDtailsByUserId?userId=${lowestDealerBidder}`);
//         if (!response.ok) {
...
//               const fetchDealerData = async () => {
//                 try {
//                   const response = await fetch(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/RaiseAQuoteByDealer/GetRaiseAQuoteLowestDealerByid?raiseAQuotetDealerId=${raiseTicketId}`);
//                   if (!response.ok) {
//                     throw new Error('Failed to fetch ticket data');
//                   }
...
//   try {
//     const response = await fetch(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/Payment/CreatePayment`, {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
...
//   try { 
//     const response = await fetch(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/Payment/sendLowestBidderDealerNotifications?ticketId=${ticketId}&ConfirmationCode=${technicianConfirmationCode}&technicianPhoneNumber=${dealerPhoneNumber}`, {
//       method: 'GET',
//       headers: {
//         'Content-Type': 'application/json',
//       },
