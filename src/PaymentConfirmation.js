...
//       try {
//         const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Dealer/GetDealerDtailsByUserId?userId=${lowestDealerBidder}`);
//         if (!response.ok) {
...
//               const fetchDealerData = async () => {
//                 try {
//                   const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/RaiseAQuoteByDealer/GetRaiseAQuoteLowestDealerByid?raiseAQuotetDealerId=${raiseTicketId}`);
//                   if (!response.ok) {
//                     throw new Error('Failed to fetch ticket data');
//                   }
...
//   try {
//     const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Payment/CreatePayment`, {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
...
//   try { 
//     const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Payment/sendLowestBidderDealerNotifications?ticketId=${ticketId}&ConfirmationCode=${technicianConfirmationCode}&technicianPhoneNumber=${dealerPhoneNumber}`, {
//       method: 'GET',
//       headers: {
//         'Content-Type': 'application/json',
//       },
