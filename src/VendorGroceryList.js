...
const VendorGroceryList = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      try {
        const url = `https://apiqa-b5cyfzbhhah5adc9.westus2-01.azurewebsites.net/api/VendorRegistration/GetVendorGroceryListByVendorId?vendorId=${vendorId}`;
      ...
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex justify-content-end align-items-center col-md-6">
          <button
            ...
            onClick={() => navigate(`/VendorUploadGrocery/${vendorId}`)}
          >
            Add New Grocery
          </button>
        </div>
...
export default VendorGroceryList;
