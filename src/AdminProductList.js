...
const AdminProductList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/Product/GetAdminProductList?ProductOwnedBy=Admin`;
    axios.get(url)
      .then((response) => {
  ...
  const handleDelete = (productId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/Product/${productId}`)
        .then(() => {
