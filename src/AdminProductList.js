...
const AdminProductList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Product/GetAdminProductList?ProductOwnedBy=Admin`;
    axios.get(url)
      .then((response) => {
  ...
  const handleDelete = (productId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Product/${productId}`)
        .then(() => {
