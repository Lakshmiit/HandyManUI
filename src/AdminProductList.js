...
const AdminProductList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/Product/GetAdminProductList?ProductOwnedBy=Admin`;
    axios.get(url)
      .then((response) => {
  ...
  const handleDelete = (productId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/Product/${productId}`)
        .then(() => {
