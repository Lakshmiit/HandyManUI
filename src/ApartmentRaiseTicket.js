...
const fetchApartmentData = useCallback(async () => {
  setLoading(true);
  try {
    const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/ApartmentMaintenance/GetAddressMaintenanceDataByMobileNo?mobileNo=${mobileNumber}`);
...
useEffect(() => {
  ...
  const uploadFile = async (byteArray, fileName, mimeType, file) => {
    try {
      ...
      const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/FileUpload/upload?filename=` + fileName, {
        method: 'POST',
        headers: {
          'Accept': 'text/plain',
        },
  ...
  try {
    const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/ApartmentRaiseTicket/CreateApartmentRaiseTicket`, {
      method: 'POST',
      headers: {
  ...
  try {
    const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/ApartmentMaintenance/CreateApartmentMaintence`, {
      method: 'POST',
  ...
  const handleAddressEdit = async () => {  
    ...
    if (!/^\d{6}$/.test(pinCode)) {
      ...
      try {
        const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/ApartmentMaintenance/${id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
