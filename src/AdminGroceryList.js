...
const AdminGroceryList = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      try {
        const url = "https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/UploadGrocery/GetAllGroceryItemsForAdmin";
  ...
  const handleDelete = async (groceryId) => {
    ...
    try {
      await axios.delete(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/UploadGrocery?id=${groceryId}`);
