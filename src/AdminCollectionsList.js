...
const AdminCollectionsList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/UploadLakshmiCollection/GetAllLakshmiCollections`;
    axios.get(url)
      .then((response) => {
  ...
  const handleDelete = (collectionId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Product/${collectionId}`)
        .then(() => {
