...
//     try {
//       //imageUrls="";
//       const response = await fetch(`https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/RaiseAQuote/CreateRaiseAQuote`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//       // window.location.href = `https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/CustomerProfilePage?ReactToken=${technicianId}$${userType}`;
//     } catch (error) {
...
//             `https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/RaiseAQuote/GetRaiseAQuoteDetailsByTechnicianId?raiseAQuotetId=${raiseTicketId}&TechnicianId=${userId}`
//           );
