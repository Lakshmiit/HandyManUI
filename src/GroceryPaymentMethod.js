...
`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Mart/GetProductDetails?id=${groceryItemId}`,
{ signal: ctrl.signal },
);
...
// const url = `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/ReferralPoints/GetReferralPointsByUserId?referreId=${encodeURIComponent(userId)}`;
...
useEffect(() => {
axios
.get(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/MasterData/getStates`)
.then((response) => {
...
if (stateId) {   
axios
.get(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/MasterData/getDistricts/${stateId}`)
.then((response) => {
...
try {
const response = await fetch(
`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Customer/CustomerAddressEdit`,
{
method: "POST",
headers: {
...
`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Mart/UpdateProductDetails/${groceryItemId}`,
{
method: "PUT",
...
// `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/ReferralPoints/UpdateReferralPoints?id=${encodeURIComponent(id)}`,
// {
// method: "PUT",
...
// if (!resp.ok) {
// resp = await fetch(
// `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/ReferralPoints/UpdateReferralPoints/${encodeURIComponent(id)}`,
// {
// method: "PUT",
// headers: { "Content-Type": "application/json; charset=utf-8" },
// body: JSON.stringify(payloadPut),
...
`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/UploadGrocery/UpdateGroceryItems?id=${encodeURIComponent(item.id)}`,
{
method: "PUT",
headers: { "Content-Type": "application/json" },
body: JSON.stringify(payload),
...
primaryAddress?.mobileNumber || primaryAddress?.mobileNumber;
const response = await fetch(
`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Auth/sendLmartsms`,
{
method: "POST",
headers: {
"Content-Type": "application/json",
...
//  const fetchCustomerData = useCallback(async () => {
//       try {
//         const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Address/GetAddressById/${userId}`);
//         if (!response.ok) {
...
//       try {
//         const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Customer/CustomerAddressEdit`, {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
//           },
...
//    if (selectedPayment === 'online') {
//      response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Mart/UpdateProductDetails/${groceryItemId}`, {
//       method: 'PUT',
//       headers: {
//         'Content-Type': 'application/json',
//       },
...
//     const primaryAddress = addresses.find((addr) => addr.type === "primary");
//     const mobileNumber = primaryAddress?.mobileNumber || primaryAddress?.mobileNumber; 
//     const response = await fetch("https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/Auth/sendLmartsms", {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
