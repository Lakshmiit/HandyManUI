...
// const CustomerCareNotificationGrid = () => {
...
//           ...ticket,
//         }));
//         const pendingTickets = tickets.filter((ticket) => ticket.internalStatus === "Closed");
...
//         <h2 className="text-center mb-4">Customer Care Notifications</h2>
...
//                   <Link
//                     to={`/customerCareConfirmation/${ticket.id}`}
...
// export default CustomerCareNotificationGrid;
