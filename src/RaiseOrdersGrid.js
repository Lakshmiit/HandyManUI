...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const url = `https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByDistrict?district=${district}&category=${category}`;
    axios
      .get(url)
      .then((response) => {
