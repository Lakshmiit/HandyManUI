...
const AdminGroceryApproval = () => {
  ...
  useEffect(() => {         
    const fetchData = async () => {
      try {
        const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/UploadGrocery/GetGroceryItems/${id}`);
  ...
  const handleSubmit = async () => {
    ...
    try {   
      const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/UploadGrocery/UpdateGroceryItems?id=${id}`, {
        method: "PUT",
