...
useEffect(() => {
    const fetchTechnicianData = async () => {
      try {
        const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/UploadJobDescriptionBookTechnician/GetTicket/${id}`);
        if (!response.ok) {
...
//     try {
//       const response = await fetch("https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/Product/ProductUpload", {
//         method: "POST",
//         headers: {
...
const handleUpdateJobDescription = async (e) => {
    ...
    try {
      const response = await fetch(`https://lmartzoneav1-bhdzfxcse7ctdxbd.westus2-01.azurewebsites.net/api/UploadJobDescriptionBookTechnician/${descriptionId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
