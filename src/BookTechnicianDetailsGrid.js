...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/BookTechnician/GetBookTechnicianNotifications?category=${category}&pincode=${pincode}&technicianName=${technicianName}`;
//     axios.get(url)
//       .then((response) => {
