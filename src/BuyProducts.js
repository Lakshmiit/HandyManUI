              ...
              {addresses
                  ...
                  {serviceUnavailable && (
                        <div className="alert alert-danger">
                          <strong>Note:</strong> Currently, the options to Raise a Ticket or Book Technician or Buy Product services are unavailable in your district.
        ...
        <div class="text-justify">
            ...
            <div className="d-flex justify-content-between mt-3">
               <button
                ...
                disabled={noProductNameError || isAddressInvalid || disableBuy || serviceUnavailable} 
              >
                Buy Product
              </button>
              <Button
