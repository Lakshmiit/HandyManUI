...
useEffect(() => {
  ...
  try {
    ...
    if (paymentMode === "technician" && (paymentType === "Cash" || paymentType === "Pay Online")) {
        response = await fetch(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/RaiseTicket/${raiseTicketId}`, {
          method: 'PUT',
          headers: {
  ...
  try {
    const response = await fetch(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/DeliveryNote/${id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
...
//     let response
//     if (paymentMode === "technician" && (paymentType === "Cash" || paymentType === "Pay Online")) {
//         response = await fetch(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/Payment/${paymentId}`, {
//           method: 'PUT',
//           headers: {
//             'Content-Type': 'application/json',
//           },
