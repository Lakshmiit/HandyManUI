...
const categories = [
    ...
    { label: 'Hardware Items',value:'Hardware items', icon: <ConstructionIcon sx={{ fontSize: 40, color: '#512da8' }} /> },
  ]; 
  ...
  useEffect(() => {
    ...
    const handleCategoryClick = async (category) => {
        ...
        try {
          ...
          navigate(`/offersGuest/customer/guest`, {
...
<div className={`container m-5 ${isMobile ? 'w-100' : 'w-100'}`}>
