...
//     const url = `https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/ReferralPoints/GetReferralPointsByUserId?referreId=${encodeURIComponent(
//       userId
//     )}`;
...
//     if (record?.id) {
//       const putUrl = `https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/ReferralPoints/UpdateReferralPoints?id=${encodeURIComponent(
//         record.id
//       )}`;
...
//       return d || { ok: true };
//     } else {
//       const postUrl = `https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/ReferralPoints/UploadReferralPoints`;
...
//       const smsRes = await fetch(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/Auth/sendpromosms`, {
//         method: "POST",
