...
const AdminCollectionNotificationGrid = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const url = `https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/LakshmiCollection/GetAllLakshmiCollectionsOpen`
    axios.get(url)
      .then(response => {
  ...
  const handleDelete = (collectionId) => {
    ...
    if (confirmDelete) {
      axios.delete(`https://handymanwebapp1-ezgyf8bxf4dtcqd2.z01.azurefd.net/api/RaiseTicket/${collectionId}`)
        .then(() => {
