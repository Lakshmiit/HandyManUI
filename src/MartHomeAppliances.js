    ...
    <>
      ...
      >
        ...
        <Modal.Body className="text-start">
          ...
          >
            {zoomProduct?.images?.map((img, idx) => (
              <img
                key={idx}
                src={
                  imageUrls[zoomProduct.id]?.[idx] ||
                  imageUrls[zoomProduct.id]?.[0]
                }
                alt={`product-${idx}`}
                style={{
                  height: "200px",
          ...
          <h5 className="mb-1" style={{ fontSize: "16px", fontWeight: "bold" }}>
            {zoomProduct?.name}
          </h5>
          <div className="mb-2" style={{ fontSize: "14px" }}>
            ...
            {zoomProduct?.discount > 0 && (
              <span className="text-danger">{zoomProduct.discount}%</span>
            )}
          </div>
