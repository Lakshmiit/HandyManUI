  ...
  return (
    <div className="container py-4 pb-5">
            ...
            <div className="row g-3">
              {categories.map((category) => {
                ...
                return <div className="col-12 col-sm-6 col-lg-4" key={category}>
                  <button className="card w-100 h-100 text-start border-0 shadow-sm" onClick={() => setSelectedCategory(category)}>
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-start gap-2"><h5 className="mb-1">{category}</h5><span className="badge bg-success">{count}</span></div>
      ...
      <div className="position-sticky bottom-0 bg-white border-top mt-4 py-3 d-flex justify-content-between align-items-center gap-3 flex-wrap">
        ...
        <button className="btn btn-success px-4" onClick={submitForApproval} disabled={submitting || selectedIds.length === 0}>
