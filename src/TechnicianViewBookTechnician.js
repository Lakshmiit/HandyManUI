...
//                   apiUrl = `https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/api/technician/technicianProfileData?profileType=${userType}&UserId=${userId}`;
...
//   // window.location.href = `https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/CustomerProfilePage?ReactToken=${customerId}$${userType}`;
//   } catch (error) {
