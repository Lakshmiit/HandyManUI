          ...
          <div className="modal-content">
            ...
            <div className="text-justify">
                    ...
                    <div className="mt-20">
                        ...
                        <p>
                            You further acknowledge that conduct prohibited in connection with your use of the Lakshmi Sai Service Provider (https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net) website includes, but is not limited to, breaching or attempting to breach the security of the Site.
                        </p>
                        <div className="mt-20">
