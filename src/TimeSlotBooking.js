...
//           onChange={(e) => handleTimeSlotClick(e.target.value)}
//         >
...
//                         </p>
//                         <p>
//                             You further acknowledge that conduct prohibited in connection with your use of the Lakshmi Sai Service Provider (https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net) website includes, but is not limited to, breaching or attempting to breach the security of the Site.
//                         </p>
//                         <div className="mt-20">
...
//             // disabled={activeTab === "Option 2" && !isChecked}
//             >
//               {activeTab === "Option 1" ? "Continue" : "Submit"}
//             </button>
//           </div>
//         </div>
//     </div>
