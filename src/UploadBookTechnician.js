...
const handleUploadJobDescription = async (e) => {
  ...
  setError("");
    ...
    try {
      const response = await fetch(`https://handymanapiv13-c7gjhhefa2bfgedb.centralindia-01.azurewebsites.net/api/UploadJobDescriptionBookTechnician/CreateUploadJobDescriptionBookTechnician`, {
        method: 'POST',
        headers: {
