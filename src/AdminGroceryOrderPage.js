...
useEffect(() => {
  ...
  //         `https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/UploadGrocery/UpdateGroceryItems?id=${encodeURIComponent(
  //           item.id
  //         )}`,
  //         {
  //           method: "PUT",
...
useEffect(() => {
  const fetchDeliveryPartners = async () => {
    try {
      const response = await axios.get(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/DeliveryPartner/GetAllDeliveryPartners`);
...
//     let response = await fetch(`https://handymanapiv4-d4baa3hhdcftgabe.centralindia-01.azurewebsites.net/api/Mart/UpdateProductDetails/${groceryItemId}`, {
//       method: 'PUT',
//       headers: {
