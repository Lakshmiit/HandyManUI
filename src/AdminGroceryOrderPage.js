...
useEffect(() => {
  const fetchDeliveryPartners = async () => {
    try {
      const response = await axios.get(`https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/api/DeliveryPartner/GetAllDeliveryPartners`);
...
//     let response = await fetch(`https://handymanapiv14-cvccacc0cbggefds.centralindia-01.azurewebsites.net/api/Mart/UpdateProductDetails/${groceryItemId}`, {
//       method: 'PUT',
//       headers: {
