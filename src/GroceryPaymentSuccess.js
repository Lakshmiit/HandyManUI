...
// useEffect(() => {
//     fetch(`https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/Mart/GetProductDetails?id=${id}`)
//       .then((res) => res.json())
//       .then((data) => {
...
//           "https://lmartapiv1-fxcyd2b4btacgsav.westus2-01.azurewebsites.net/api/Mart/GroceryItemsEdit",
//           {
//             method: "POST",
